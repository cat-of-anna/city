<template>
  <div style="padding: 20px">
          ...
          <el-table-column label="二维码">
            ...
            <template slot-scope="scope">
              <el-popover
                ...
                <el-image slot="reference" style="width: 40px; height: 40px" :src="scope.row.url" fit="fit"></el-image>
              </el-popover>
    ...
    <el-drawer title="添加推广码" :visible.sync="drawerVisible" direction="ltr" :before-close="handleDrawerClose">
